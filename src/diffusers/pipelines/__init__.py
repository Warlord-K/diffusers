...
try:
    ...
    _import_structure["flux"] = ["FluxPipeline", "FluxDifferentialImg2ImgPipeline", "FluxControlNetPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .flux import FluxControlNetPipeline, FluxDifferentialImg2ImgPipeline, FluxPipeline
